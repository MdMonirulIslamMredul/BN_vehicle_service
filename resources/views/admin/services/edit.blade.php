                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="role" id="role" class="form-control @error('role') is-invalid @enderror"
                            value="{{ old('role', $service->role) }}" readonly>
                        @error('role')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="date" class="form-control @error('date') is-invalid @enderror"
                            value="{{ old('date', $service->date ? $service->date->format('Y-m-d') : '') }}">
                        @error('date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="reg_no" id="reg_no" class="form-control @error('reg_no') is-invalid @enderror"
                            value="{{ old('reg_no', $service->reg_no) }}">
                        @error('reg_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="chassis_no" id="chassis_no" class="form-control @error('chassis_no') is-invalid @enderror"
                            value="{{ old('chassis_no', $service->chassis_no) }}">
                        @error('chassis_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="time" name="entry_time" class="form-control @error('entry_time') is-invalid @enderror"
                            value="{{ old('entry_time', $service->entry_time ? \Carbon\Carbon::parse($service->entry_time)->format('H:i') : '') }}">
                        @error('entry_time')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="job_no" class="form-control @error('job_no') is-invalid @enderror"
                            value="{{ old('job_no', $service->job_no) }}">
                        @error('job_no')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="drv_name" class="form-control @error('drv_name') is-invalid @enderror"
                            value="{{ old('drv_name', $service->drv_name) }}">
                        @error('drv_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" name="tk_amount" class="form-control @error('tk_amount') is-invalid @enderror"
                            value="{{ old('tk_amount', $service->tk_amount) }}">
                        @error('tk_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror">
                            <option value="entry" {{ old('status', $service->status) === 'entry' ? 'selected' : '' }}>Entry</option>
                            <option value="running" {{ old('status', $service->status) === 'running' ? 'selected' : '' }}>Running</option>
                            <option value="finished" {{ old('status', $service->status) === 'finished' ? 'selected' : '' }}>Finished</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="job_description" rows="4" class="form-control @error('job_description') is-invalid @enderror">{{ old('job_description', $service->job_description) }}</textarea>
